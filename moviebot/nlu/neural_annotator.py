...
class NeuralAnnotator(SlotAnnotator):
    ...
    def __init__(self, _process_value, _lemmatize_value, slot_values):
        self.base_url = './third_party/REL'
        self.wiki_version = 'wiki_2014'
    ...
    def _person_name_annotator(self, utterance, slots=None):
        ...
        """
        input_text = self.preprocess_for_rel(utterance)
        ...
        config = {
            "mode": "eval",
            "model_path": "./third_party/REL/ed-wiki-2014/model",
        }
    ...
    def preprocess_for_rel(self, raw_utterance):
        return {
            'query': [raw_utterance, []],
        }
